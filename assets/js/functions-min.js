! function (t, e, i, n) {
    ...
    function wws() {
       $(".web-slider--prev, .web-slider--next").click(function () {
          var t = $(this),
             e = $(".web-slider").find(".web-slider--item-left"),
             i = $(".web-slider").children().index(e),
             n = $(".web-slider").find(".web-slider--item-center"),
             s = $(".web-slider").children().index(n),
             r = $(".web-slider").find(".web-slider--item-right"),
             o = $(".web-slider").children().index(r),
             a = $(".web-slider").children().length,
             l = $(".web-slider--item-left"),
             c = $(".web-slider--item-center"),
             h = $(".web-slider--item-right"),
             u = $(".web-slider--item");
          $(".web-slider").animate({
             opacity: 0
          }, 400), setTimeout(function () {
             t.hasClass("web-slider--next") ? a - 1 > i && a - 1 > s && a - 1 > o ? (l.removeClass("web-slider--item-left").next().addClass("web-slider--item-left"), c.removeClass("web-slider--item-center").next().addClass("web-slider--item-center"), h.removeClass("web-slider--item-right").next().addClass("web-slider--item-right")) : i === a - 1 ? (u.removeClass("web-slider--item-left").first().addClass("web-slider--item-left"), c.removeClass("web-slider--item-center").next().addClass("web-slider--item-center"), h.removeClass("web-slider--item-right").next().addClass("web-slider--item-right")) : s === a - 1 ? (l.removeClass("web-slider--item-left").next().addClass("web-slider--item-left"), u.removeClass("web-slider--item-center").first().addClass("web-slider--item-center"), h.removeClass("web-slider--item-right").next().addClass("web-slider--item-right")) : (l.removeClass("web-slider--item-left").next().addClass("web-slider--item-left"), c.removeClass("web-slider--item-center").next().addClass("web-slider--item-center"), u.removeClass("web-slider--item-right").first().addClass("web-slider--item-right")) : 0 !== i && 0 !== s && 0 !== o ? (l.removeClass("web-slider--item-left").prev().addClass("web-slider--item-left"), c.removeClass("web-slider--item-center").prev().addClass("web-slider--item-center"), h.removeClass("web-slider--item-right").prev().addClass("web-slider--item-right")) : 0 === i ? (u.removeClass("web-slider--item-left").last().addClass("web-slider--item-left"), c.removeClass("web-slider--item-center").prev().addClass("web-slider--item-center"), h.removeClass("web-slider--item-right").prev().addClass("web-slider--item-right")) : 0 === s ? (l.removeClass("web-slider--item-left").prev().addClass("web-slider--item-left"), u.removeClass("web-slider--item-center").last().addClass("web-slider--item-center"), h.removeClass("web-slider--item-right").prev().addClass("web-slider--item-right")) : (l.removeClass("web-slider--item-left").prev().addClass("web-slider--item-left"), c.removeClass("web-slider--item-center").prev().addClass("web-slider--item-center"), u.removeClass("web-slider--item-right").last().addClass("web-slider--item-right"))
          }, 400), $(".web-slider").animate({
             opacity: 1
          }, 400)
       })
    }
    ...
    function gs() {
        $(".graphic-slider--prev, .graphic-slider--next").click(function () {
           var t = $(this),
              e = $(".graphic-slider").find(".graphic-slider--item-left"),
              i = $(".graphic-slider").children().index(e),
              n = $(".graphic-slider").find(".graphic-slider--item-center"),
              s = $(".graphic-slider").children().index(n),
              r = $(".graphic-slider").find(".graphic-slider--item-right"),
              o = $(".graphic-slider").children().index(r),
              a = $(".graphic-slider").children().length,
              l = $(".graphic-slider--item-left"),
              c = $(".graphic-slider--item-center"),
              h = $(".graphic-slider--item-right"),
              u = $(".graphic-slider--item");
           $(".graphic-slider").animate({
              opacity: 0
           }, 400), setTimeout(function () {
              t.hasClass("graphic-slider--next") ? a - 1 > i && a - 1 > s && a - 1 > o ? (l.removeClass("graphic-slider--item-left").next().addClass("graphic-slider--item-left"), c.removeClass("graphic-slider--item-center").next().addClass("graphic-slider--item-center"), h.removeClass("graphic-slider--item-right").next().addClass("graphic-slider--item-right")) : i === a - 1 ? (u.removeClass("graphic-slider--item-left").first().addClass("graphic-slider--item-left"), c.removeClass("graphic-slider--item-center").next().addClass("graphic-slider--item-center"), h.removeClass("graphic-slider--item-right").next().addClass("graphic-slider--item-right")) : s === a - 1 ? (l.removeClass("graphic-slider--item-left").next().addClass("graphic-slider--item-left"), u.removeClass("graphic-slider--item-center").first().addClass("graphic-slider--item-center"), h.removeClass("graphic-slider--item-right").next().addClass("graphic-slider--item-right")) : (l.removeClass("graphic-slider--item-left").next().addClass("graphic-slider--item-left"), c.removeClass("graphic-slider--item-center").next().addClass("graphic-slider--item-center"), u.removeClass("graphic-slider--item-right").first().addClass("graphic-slider--item-right")) : 0 !== i && 0 !== s && 0 !== o ? (l.removeClass("graphic-slider--item-left").prev().addClass("graphic-slider--item-left"), c.removeClass("graphic-slider--item-center").prev().addClass("graphic-slider--item-center"), h.removeClass("graphic-slider--item-right").prev().addClass("graphic-slider--item-right")) : 0 === i ? (u.removeClass("graphic-slider--item-left").last().addClass("graphic-slider--item-left"), c.removeClass("graphic-slider--item-center").prev().addClass("graphic-slider--item-center"), h.removeClass("graphic-slider--item-right").prev().addClass("graphic-slider--item-right")) : 0 === s ? (l.removeClass("graphic-slider--item-left").prev().addClass("graphic-slider--item-left"), u.removeClass("graphic-slider--item-center").last().addClass("graphic-slider--item-center"), h.removeClass("graphic-slider--item-right").prev().addClass("graphic-slider--item-right")) : (l.removeClass("graphic-slider--item-left").prev().addClass("graphic-slider--item-left"), c.removeClass("graphic-slider--item-center").prev().addClass("graphic-slider--item-center"), u.removeClass("graphic-slider--item-right").last().addClass("graphic-slider--item-right"))
           }, 400), $(".graphic-slider").animate({
              opacity: 1
           }, 400)
        })
     }
